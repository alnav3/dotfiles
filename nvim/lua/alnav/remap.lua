--local function setup_format_on_attach(bufnr)
--    local format_commands = {
--        ["%.templ$"] = ":!templ fmt %",
--        ["%.go$"] = ":!gofmt %",
--        ["%.java$"] = ":!google-java-format --aosp -i %",
--    }
--
--    local bufname = vim.fn.expand("%:p")
--    local command = nil
--
--    for pattern, fmt_command in pairs(format_commands) do
--        if vim.fn.matchstr(bufname, pattern) ~= "" then
--            command = fmt_command
--            break
--        end
--    end
--
--    local function preserve_cursor(callback)
